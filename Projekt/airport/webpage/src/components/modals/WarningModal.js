...
export default function WarningModal({ open, setOpen, text }) {
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-transparent text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="bg-gray-800 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="flex justify-center items-center self-center">
                    <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-orange-300 sm:mx-0 sm:h-10 sm:w-10">
                      <svg
                        class="w-6 h-6"
                        aria-hidden="true"
                  ...
                  <div className="sm:flex sm:items-start mt-5">
                    <div className="mt-3 text-center  sm:mt-0 sm:text-left">
                      <Dialog.Title
                        as="h3"
                        className="text-center font-semibold leading-6 text-orange-500"
                      >
                        Wystąpił błąd
                      </Dialog.Title>
                      <div className="mt-2">
