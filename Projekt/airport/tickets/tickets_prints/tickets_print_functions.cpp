...
void printTicketInvoice(
    ...
    auto createScreen = [&] {
        auto summary = ftxui::vbox({
            ...
            ftxui::separator(),
            ftxui::hbox({ftxui::paragraphAlignLeft("Data: " + date) | ftxui::bold | color(ftxui::Color::GrayLight),
            ...
            ftxui::separator(),
            ftxui::hbox({ftxui::paragraphAlignRight("Zapłacono: " + targetPrice + " PLN") | ftxui::bold | color(ftxui::Color::Gold1)}),
