...
std::string CreateSettingsMenu(const User &user) {
  auto createSettingsScreen = [&] {
    auto summary = ftxui::vbox({
                                   ...
                                   ftxui::hbox({ftxui::paragraphAlignRight("Zalogowano jako:")})
                                       | color(ftxui::Color::GrayDark),
                                   ftxui::hbox({ftxui::paragraphAlignRight(user.username)})
                                       | color(ftxui::Color::GrayDark),
  ...
  auto summary = [&] {
    auto content = ftxui::vbox({
                                   ...
                                   ftxui::hbox({ftxui::text("Wykonywany zawód: ")
                                                ...
                                                (user.profession == "brak") ? ftxui::text("Brak")
                                   ...
                                   ftxui::hbox({ftxui::text("Karta premium: ") | ftxui::color(ftxui::Color::GrayLight)
                                                    | ftxui::bold,
                                                (user.premiumCard == "brak") ? ftxui::text("Brak")
                                                    | ftxui::color(ftxui::Color::GrayDark) : (user.premiumCard
                                                    == "złota") ? ftxui::text(premiumCard)
                                                                                                 | ftxui::color(ftxui::Color::Gold1)
                                                                : (user.premiumCard == "niebieska") ?
