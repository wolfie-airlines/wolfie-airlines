...
bool Authentication::RegisterUser(const std::string &username, const std::string &email, const std::string &password) {
    ...
    if (usernameAlreadyExists) {
        PrintErrorMessage("The username you entered is already taken.", "Choose another name.");
        return false;
    }

    auto email_already_exists =
        _collection_.find_one(bsoncxx::builder::basic::make_document(bsoncxx::builder::basic::kvp("email", email)));
    if (email_already_exists) {
        PrintErrorMessage("The e-mail address provided is already taken.", "Choose a different email address.");
        return false;
    }
    ...
    document.append(bsoncxx::builder::basic::kvp("profession", "none"));
    document.append(bsoncxx::builder::basic::kvp("premiumCard", "none"));
    ...
    document.append(bsoncxx::builder::basic::kvp("discountType", "none"));
...
void Authentication::AuthenticateUser(const std::string &username,
    ...
    if (result) {
        ...
        PrintSuccessMessage("Logged in successfully.", "Welcome to the system.");
    } else {
        PrintErrorMessage("Incorrect data has been entered or such user does not exist.", "");
